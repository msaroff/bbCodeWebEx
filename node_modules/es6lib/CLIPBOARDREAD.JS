(function(global) {
    ...
    const factory = function es6lib_dom(exports) { // license: MIT
        ...
        /**
         * The functions in this module use the global 

        windows context (document, URL, self, top, etc.) by default.
         * To have any of the functions of this module operate on a different scope, call them 

        with that scope as this,
         ...
         * @param  {string}        
          ...
          tagName     Type of the new Element to create.
         * @param  {object}          properties  Optional. Object (not Array) of properties, which are 

        deeply copied onto the new element.
         * @param  {Array<Element>}  childList   Optional. Array of elements or strings (as Text nodes) to set as the 

        children of the new element. Nested Array are recursively flattened.
        ...
        function createElement(tagName, properties, childList) {
            ...
            properties
                ...
                (function assign(target, source) {
                    Object.keys(source).forEach(key => {
                        ...
                        (typeof value === 'object' && (typeof now === 'object' || typeof now === 'function')) {
                            assign(now, value);
                        } else {
            ...
            childList && (function append(child) {
                ...
                child && element.appendChild(typeof child === 'string' ?
        ...
        function addStyle(css) {
            return (this || global).window.document.querySelector('head').appendChild
        ...
        function clickElement(element) {
            const evt = (this || global).window.document.createEvent
        ...
        /**
         * Invokes a save dialog for a 

        Blob or an Url object or strings target.
        ...
        works in Chrome, not in Firefox (52)!
         ...
         * @return {Promise<File>}             A Promise to a (possibly 
            ...
            return new Promise(function(resolve, reject) {
                ...
                onFocus() {
                    global.setTimeout(() => {
                        ...
                        resolve([]); // file picker was opened and closed, but no 
                ...
                function onChange(event) {
                    try {
                        ...
                        resolve(Array.from
                            ...
                            (input.files)); // actually got file(s)
                    } catch (error) {
                        reject(error);
                    }
                }
        ...
        ArrayBuffer}  Promise to the data read.
         */
         ...
         * @param  {string|object}  data  Ether a plain string or an object of multiple pairs { [mimeType]: 

        data, } to write.
         * @param  {natural}        time  Optional. Maximum runtime of this asynchronous operation after which it will be canceled and 

        rejected.
         * @return {Promise}              Promise that rejects if the timeout or an error occurred. If it resolves the operation should have 
                ...
                function onCopy(event) {
                    try {
                        ...
                        (typeof data === 'string') {
                            ...
                            (data).forEach(mimeType => transfer.setData(mimeType, data[mimeType]));
                        }
        ...
        * @param  {string|[string]|null}   types  An optional (Array of) mime types to read.
         * @param  {natural}                time   Optional. Maximum 

        runtime of this asynchronous operation after which it will be canceled and rejected.
         * @return {Promise<string|object>}        Promise to the 

        current clipboard data as string. If types was an array, it returns an object of { [mimeType]: data, } pairs.
         */
        ...
        /**
         * Listen for a DOM Event on an Element only once 

        and removes the listener afterwards.
         */
        exports.once = once;
        ...
        /**
         * Get the closest parent element (or the element itself) that 

        matches a selector.
         * @param  {Element}  element   The child element whose parent is searched for
         * @param  {string}   selector  The selector the 

        parent has to match
         * @return {Element||null}      'element', if it matches 'selector' or the first parent of 'element' that matches 'selector', if 
        ...
        /**
         * Builds the strongest possible selector of tagNames, ids and classes for an Element (at 

        its current position in the document).
        ...
        resolves once the 'DOMContentLoaded' event is/was fired.
         */
