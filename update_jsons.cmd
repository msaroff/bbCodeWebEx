...
@rem directory.
@rem %userprofile%\Documents\github\bbcodewebex\Lynx\lynx.exe 
@rem -cfg=%userprofile%\Documents\github\bbcodewebex\lynx\lynx.cfg -dump -width 300 .\DefMenu.htm > DefMenu.json
