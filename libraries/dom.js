(function(global) {
    'use strict';
    const factory = function es6lib_dom(exports) { // license: MIT
        ...
        function createElement(tagName, properties, childList) {
            ...
            if (Array.isArray(properties)) {
                childList = properties;
                properties = null;
            }
            properties && (function assign(target, source) {
            ...
            childList && (function append(child) {
                if (Array.isArray(child)) {
                    return void child.forEach(append);
                }
        ...
        function writeToClipboard(data, time) {
            return new Promise(function(resolve, reject) {
                const document = (this || global).window.document;
                let done = false;
        ...
        function readFromClipboard(types, time) {
            return new Promise(function(resolve, reject) {
                const document = (this || global).window.document;
                let done = false;
...
//                        transfer.clearData();
        ...
        function once(element, event, callback, capture) {
            function handler() {
        ...
        exports.whileVisible = whileVisible;

        function whileVisible(callback, time) {
            let handle;
            const document = (this || global).window.document;
        ...
        exports.DOMContentLoaded = new Promise((resolve, reject) => {
            ...
            if (typeof document !== 'object') {
                return void reject(new Error('No `document` global'));
            }
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        const exp = {},
            result = factory(exp) || exp;
        if (typeof exports === 'object' && typeof module === 'object') {
            module.exports = result;
        } else {
            global[factory.name] = result;
        }
    }
})((function() {
    return this;
